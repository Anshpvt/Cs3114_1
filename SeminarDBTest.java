...
public class SeminarDBTest extends TestCase {
 ...
 // Test: Searching for records
    public void testSearch() throws Exception {
        ...
        // For this test, we need to insert a record, delete it (making it a tombstone), and then search for it.
        // Test where rec is not null, but rec.isTombstone() returns true
        String[] keywords4 = {"Cloud", "AWS"};
        Record r4 = new Record(4, new Seminar(4, "Cloud Computing", "2023-11-20", 90, (short)220, (short)80, 320, keywords4, "A workshop on Cloud Computing"));
        db.insert(r4);
        db.delete(4); 
        db.search(4);
        assertTrue(outContent.toString().contains("Search FAILED -- There is no record with ID 4"));
    }
    ...
    public void testHashTableFullAndResize() {
        ...
        String[] keywords1 = {"AI", "ML"};
        Record r1 = new Record(1, new Seminar(1, "Intro to AI", "2023-10-01", 60, (short)100, (short)50, 200, keywords1, "An introduction to AI"));
        Record r2 = new Record(2, new Seminar(2, "Advanced AI", "2023-11-01", 70, (short)110, (short)60, 210, keywords1, "Advanced AI topics"));
        testDB1.insert(r1);
        testDB1.insert(r2); 
 ...
 // Test where there is not enough memory
    public void testMemoryInsufficient() throws Exception {
        ...
        Record r1 = new Record(1, new Seminar(1, "Intro to AI", "2023-10-01", 60, (short)100, (short)50, 200, keywords, "An introduction to AI"));

        ByteArrayOutputStream outContent = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outContent));

        testDB1.insert(r1);
        assertTrue(outContent.toString().contains("Not enough memory to store seminar with ID 1"));
    }
    ...
    public void testMemorySufficient() throws Exception {
        SeminarDB testDB2 = new SeminarDB(1000, 10);
        String[] keywords = {"AI", "ML"};
        Record r2 = new Record(1, new Seminar(1, "Intro to AI", "2023-10-01", 60, (short)100, (short)50, 200, keywords, "An introduction to AI"));

        ByteArrayOutputStream outContent = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outContent));

        testDB2.insert(r2);
        assertFalse(outContent.toString().contains("Not enough memory to store seminar with ID 1"));
    }
}
