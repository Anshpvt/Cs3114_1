...
/**
 * SeminarDB class represents a database for seminars, providing functionalities like insertion, 
...
public class SeminarDB {
     ...
     * @param time Time when the seminar is scheduled.
     * @param length Duration of the seminar.
     * @param x The X coordinate of the seminar location.
     * @param y The Y coordinate of the seminar location.
     * @param cost The cost to attend the seminar.
     * @param list A list of keywords associated with the seminar.
     * @param des A description of the seminar.
     */
     ...
     *
     * @param id ID of the seminar to be deleted.
     */
     ...
     *
     * @param id ID of the seminar to search for.
     */
    ...
    /**
     * Prints the content of the database. Can print the entire hash table or the list of free blocks.
     *
     * @param type A string indicating the type of content to print ("hashtable" or "block").
     */
